...
- **Canonical link registry EXISTS:** **`LINKS HQ — CURRENT` → `SEND A LINK` tab**, ID `1uPHmG_-F7qlVF6Cxe6OkNOAV4c3ma3HISWseLzqxX48`. Row-level STATUS: LIVE — CURRENT / LIVE — TRANSITIONING / NOT LIVE YET / NEEDS CHECK / RETIRED. Full offer ladder with client-facing + GHL edit + workflow links. **This is the single URL allowlist. Never duplicate URLs into skills.** *(Repointed 2026-08-02: this run referenced the former 20-tab sheet `1wy_38hh…`, which was archived 2026-08-01 as "LINKS HQ — ORIGINAL BACKUP — DO NOT USE." Per THE OPERATING SOP §2, SEND A LINK is the only source for offers, prices and client-facing URLs.)*
