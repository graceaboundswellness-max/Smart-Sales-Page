...
Target length: **1,800–3,000 words** — a range, not a quota. Length follows substance; the cut pass (§14) runs before the checklist. Reading level: **grade 7**. Register: truth over hype.
...
## 3 · Key Takeaways (3–5 bullets, directly under the Direct Answer)
...
## 5 · Why the usual answers fail (1 question-shaped H2)
...
- **Outbound citations, 3–5 across the post:** link to the specific article, study, or documentation page — never a homepage — inline at the claim it supports. Authoritative and non-competing sources only (research, data, platform docs); never the incumbents this post contradicts. Citing sources is one of the few GEO tactics with published research behind it (the Princeton GEO study).

## 7 · Story = evidence, not spine (ranking assets)
...
## 8 · The Honest Limits (1 short paragraph)
...
- [ ] 3–5 outbound citations: specific pages (never homepages), inline at the claim, authoritative non-competing sources
- [ ] Cut pass done: no heading-restating openers, no callbacks, no recaps, no word-count padding
