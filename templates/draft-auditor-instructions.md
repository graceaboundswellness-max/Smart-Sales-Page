...
5. **Voice & claims.** "Messaging" absent from body copy. No hype register (secrets/scarcity/income claims). Nothing contradicting positioning.md claims discipline (e.g., "no faith voice touches AI"). Bold ≤4. Grade-7 read.
